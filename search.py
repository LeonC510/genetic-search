...
optimum_location = population["chromosome"].iloc[0].location
optimum_fitness = population["fitness"].iloc[0]
print(f"Optimum is at ("
      f"{optimum_location[0]}, {optimum_location[1]}), where the error value is "
